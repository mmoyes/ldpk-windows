...
#include <ldpk/tde4_ldp_radial_fisheye_equidistant_longlat_z_deg_8.experimental.h>

#define CLASS_LDP_SDV         tde4_ldp_radial_fisheye_equidistant_longlat_z_deg_8
#define CLASS_IOP_SDV     iop_tde4_ldp_radial_fisheye_equidistant_longlat_z_deg_8
#define CREATE_SDV create_iop_tde4_ldp_radial_fisheye_equidistant_longlat_z_deg_8
...
static const char* const CLASS = "LD_3DE4_Radial_Fisheye_Equidistant_Longlat_Z_Degree_8";
...
//! Nuke plugin based on tde4_ldp_radial_fisheye_equidistant_longlat_z_deg_8
class iop_tde4_ldp_radial_fisheye_equidistant_longlat_z_deg_8:public nuke_ld_3de4_base
	{
public:
	CLASS_IOP_SDV(Node* node):nuke_ld_3de4_base(node,new CLASS_LDP_SDV<ldpk::vec2d,ldpk::mat2d>())
		...
		if(_verbose_constructor)
			{
			std::cout << "iop_tde4_ldp_radial_fisheye_equidistant_longlat_z_deg_8::ctor: node: " << node << std::endl;
			std::cout << "iop_tde4_ldp_radial_fisheye_equidistant_longlat_z_deg_8::ctor: this: " << this << std::endl;
			}
		}
	~CLASS_IOP_SDV()
		{
		if(_verbose_destructor)
			{
			std::cout << "iop_tde4_ldp_radial_fisheye_equidistant_longlat_z_deg_8::dtor: this: " << this << std::endl;
			}
		}
